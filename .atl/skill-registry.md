...
- Path: /Volumes/DeveloperDisk/Projects/livecomerce/.agents/skills/stripe-best-practices/SKILL.md
- Trigger: >-
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### stripe-projects
- Path: /Volumes/DeveloperDisk/Projects/livecomerce/.agents/skills/stripe-projects/SKILL.md
- Trigger: >-
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### upgrade-stripe
- Path: /Volumes/DeveloperDisk/Projects/livecomerce/.agents/skills/upgrade-stripe/SKILL.md
